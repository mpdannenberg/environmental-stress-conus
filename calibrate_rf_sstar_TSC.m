...
% Absolute stress index (S*), predicted using all variables (TSC)
...
% for i = 80:10:130
    ...
    if n>=n_min
        ...
        set(gca, 'XLim',[0 1], 'YLim',[0,1], 'FontName','Times New Roman');
        ...
        text(0.1, 0.9, ['r^{2} = ', num2str(round(r2, 2))], 'FontName','Times New Roman');
        hold on;
...
boxplot(SoilImpEcoL1, 'PlotStyle','compact', 'Colors',[0.4 0.4 0.4],...
    'Orientation','Horizontal', 'Jitter',0);
ax = gca;
set(ax, 'FontName','Times New Roman', 'YTick', 1:nSoil,'XLim',[-0.2 1.3],... 
    'YTickLabel',SoilLabs);
...
cd RF_v4_TSC;
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','RF_v4_TSC_ValStats.tif')

save('RF_v4_TSC_stats.mat','L1_stats','L2_stats','L3_stats','L1_corrs','L2_corrs','L3_corrs','AllLabs', '-v7.3');
