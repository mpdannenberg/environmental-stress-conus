...
% Absolute stress index (S*), predicted using topography and climate (TC)
...
cd RF_v4_TC;
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','RF_v4_TC_ValStats.tif')

save('RF_v4_TC_stats.mat','L1_stats','L2_stats','L3_stats', '-v7.3');
