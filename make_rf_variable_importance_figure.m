...
print('-dtiff','-f1','-r300','./output/rf-variable-importance-L1.tif')
close all;
...
xtickangle(360-45)
ax = gca;
ax.Position = [0.1300    0.1695    0.74    0.7555];

cb = colorbar('eastoutside');
cb.Position = [0.89    0.1701    0.0342    0.7535];
ylb = ylabel(cb, '\DeltaError');
cb.FontSize = 9;
cb.Ticks = 0:0.125:1;
cb.TickLabels = {'0','','0.25','','0.5','','0.75','','1'};
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r300','./output/rf-variable-importance-L2.tif')
close all;
...
xtickangle(360-45)
ax = gca;
ax.Position = [0.1300    0.08    0.7750    0.8150];

cb = colorbar('northoutside');
cb.Position = [0.1298    0.91    0.7756    0.0317];
ylb = ylabel(cb, '\DeltaError');
cb.FontSize = 9;
cb.Ticks = 0:0.125:1;
cb.TickLabels = {'0','','0.25','','0.5','','0.75','','1'};
