...
% Relative stress index (Sr), predicted using climate only (C)
...
cd RF_v6_RSI_C;
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','RF_v6_RSI_C_ValStats.tif')

save('RF_v6_RSI_C_stats.mat','L1_stats','L2_stats','L3_stats', '-v7.3');
