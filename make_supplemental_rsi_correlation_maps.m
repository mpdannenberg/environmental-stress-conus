...
% RELATIVE environmental stress index
...
print('-dtiff','-f1','-r300','./output/supplemental-rsi-correlations-temperature.tif')
close all;
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r300','./output/supplemental-rsi-correlations-water.tif')
close all;
