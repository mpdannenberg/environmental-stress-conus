...
% Relative stress index (Sr), predicted using soil and climate (SC)
...
cd RF_v6_RSI_SC;
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','RF_v6_RSI_SC_ValStats.tif')

save('RF_v6_RSI_SC_stats.mat','L1_stats','L2_stats','L3_stats', '-v7.3');
