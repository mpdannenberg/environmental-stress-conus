...
% Absolute stress index (S*), predicted using climate only (C)
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','ClimImportanceBox.tif')
...
cd RF_v4_C;
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','RF_v4_C_ValStats.tif')

save('RF_v4_C_stats.mat','L1_stats','L2_stats','L3_stats', '-v7.3');
