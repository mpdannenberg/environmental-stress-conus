...
% Absolute stress index (S*), predicted using soil and climate (SC)
...
AllLabs = [SoilLabs TempLabs WaterLabs];
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','SoilImportanceBox.tif')
...
cd RF_v4_SC;
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r600','RF_v4_SC_ValStats.tif')

save('RF_v4_SC_stats.mat','L1_stats','L2_stats','L3_stats', '-v7.3');
